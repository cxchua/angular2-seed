System.register(['angular2/core', './author.service', './auto-grow.directive'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, author_service_1, auto_grow_directive_1;
        ...
        execute: function() {
            AuthorsComponent = (function () {
                function AuthorsComponent(authorService) {
                    this.chicken = "Chicken variable authors";
                ...
                AuthorsComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [author_service_1.AuthorZZService],
                        directives: [auto_grow_directive_1.AutoGrowDirective]
                    }), 
                    __metadata('design:paramtypes', [author_service_1.AuthorZZService])
                ], AuthorsComponent);
